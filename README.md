...
1) Bronze (The Evidence Locker): Immutable ingestion of raw identity and network logs.

2) Silver (The Investigation & Fusion): * Historical Engine (SCD Type 2): Uses dbt snapshots to track identity evolution and "Nurtured" account patterns.

Standardization: Custom REGEX logic to collapse "Address Munging" clusters in the GTA corridor.

3) Gold (The Decision Support): High-velocity marts for Whale Concentration and Bot Penetration metrics.
